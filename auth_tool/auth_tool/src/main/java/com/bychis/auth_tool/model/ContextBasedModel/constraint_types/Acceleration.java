...
public class Acceleration implements EnvironmentConstraintType {
    private float min_x,min_y,min_z;
    private float max_x,max_y,max_z;

    public Acceleration(float min_x, float min_y, float min_z, float max_x, float max_y, float max_z) {
        this.min_x = min_x;
        this.min_y = min_y;
        this.min_z = min_z;
        this.max_x = max_x;
